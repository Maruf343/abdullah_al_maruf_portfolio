export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow-2xl shadow-green-500/20 transition-transform duration-200 hover:-translate-y-1 hover:scale-105 ring-2 ring-white/30"
    >
