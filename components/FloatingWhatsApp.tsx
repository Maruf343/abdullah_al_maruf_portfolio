export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 inline-flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-green-600 text-white shadow-2xl shadow-green-500/20 transition-transform duration-200 hover:-translate-y-1 hover:scale-105 ring-2 ring-white/30"
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="sm:w-7 sm:h-7" fill="currentColor" aria-hidden>
