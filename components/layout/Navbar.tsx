  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50">
      ...
      <div className="backdrop-blur-xl bg-white/80 border-b border-slate-200/70 dark:bg-slate-950/80 dark:border-slate-800/70">
        ...
        {mobileOpen && (
          <div className="absolute inset-x-0 top-full z-40 border-t border-slate-200/70 bg-slate-50/95 px-4 py-5 shadow-2xl dark:border-slate-800/70 dark:bg-slate-950/95 md:hidden">
            <div className="flex flex-col gap-3">
              ...
              <div className="mt-3 rounded-3xl border border-slate-200 bg-white/95 p-4 text-sm text-slate-700 dark:border-slate-800 dark:bg-slate-900/95 dark:text-slate-300">
                ...
                <div className="flex flex-wrap gap-3">
                  <a href="https://github.com" target="_blank" rel="noreferrer" className="rounded-2xl bg-slate-100 px-4 py-2 text-slate-700 transition hover:bg-slate-200 dark:bg-slate-950 dark:text-slate-200 dark:hover:bg-slate-800">
                    GitHub
                  </a>
                  <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="rounded-2xl bg-slate-100 px-4 py-2 text-slate-700 transition hover:bg-slate-200 dark:bg-slate-950 dark:text-slate-200 dark:hover:bg-slate-800">
                    LinkedIn
                  </a>
                </div>
              </div>
